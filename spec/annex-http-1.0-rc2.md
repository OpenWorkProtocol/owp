# Annex A — the HTTP+JSON binding (normative)

Companion to `owp-1.0-rc2.md` §17. This annex is **normative for deployments
...
A client MAY pin a revision with `x-owp-protocol: 1.0-rc2`. A surface that does
